...
* Create APIs that enable multiple levels of abstraction.  Greater
  ...
  - Enable a simple simulation to be set up in ten to twenty lines of
    code.
...
* Provide narrative documentation that allows users to 
...
computing (JuliaIntro_). Julia uses a just-in-time (JIT) compiler with type
